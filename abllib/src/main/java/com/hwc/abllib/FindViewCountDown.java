...
public class FindViewCountDown {
    ...
    private static class DownTimer extends CountDownTimer {
        ...
        public DownTimer(long millisInFuture, long countDownInterval,
                         int step, CallBack callback, String... viewIdOrText) {
     ...
     */
    public static void start(long millisInFuture,
                             long countDownInterval, int step,
                             String... viewIdOrText) {
    ...
    public static void start(
            ...
            @NonNull CallBack callBack, String... viewIdOrText) {
