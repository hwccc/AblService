...
import com.hwc.ablservice.utils.DefaultLauncherStep;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AblConfig.Builder().setLogTag("AblService").setLog(true)
                ...
                .build().init();
        initView();
//        AblStepHandler.getInstance().initStepClass(true, new GeLeiSettingStep());
//        AblStepHandler.getInstance().initStepClass(true, new UsageRecordStep());
//        AblStepHandler.getInstance().initStepClass(true, new NoticeReadStep());
//        AblStepHandler.getInstance().initStepClass(true, new UsbStep());
//        AblStepHandler.getInstance().initStepClass(true, new BatteryOptimizedStep());
...
//                startActivity(intent);
        ...
        findViewById(R.id.bt_startAccessibilitySettings).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //启动无障碍设置
                AblStepHandler.getInstance().initStepClass(true, new DevicePolicyStep(new AblSettingCallBack() {
